...
import com.phjmmall.common.TokenCache;
import com.phjmmall.dao.UserMapper;
import com.phjmmall.pojo.User;
import com.phjmmall.service.IUserService;
import com.phjmmall.util.MD5Util;
...
//        }
    ...
    public ServerResponse<String> restPassword(String passwordOld, String passwordNew, User user) {
        //防止横向越权，要验证一下这个用户的旧密码，一定要制定这个用户，因为我们会查询一个count(1)，如果不指定id，那个结果就是true啦count > 0
    ...
    public ServerResponse<User> updateInfomation(User user) {
        //username是不能被更新的
        //email也要进行一个校验，校验新的email是不是已经存在，并且存在的email如果相同的话，不能是我们当前这个用户的email。
    ...
    * @Param: [user]
    * @return: com.phjmmall.common.ServerResponse 
    * @Author: Panhuijuan
    * @Date: 2019/8/21 
    */ 
